...
//	}
	...
	public ComicDTO consultarComic(String idComic) {
		Comic comic = new Comic();
		comic = entityManager.find(Comic.class, Long.parseLong(idComic));
	...
	public List<ComicDTO> consultarComics() {
		// TODO hacer que la listad e reulatds sea igual a nula y ver que pasa con el
		// resulatado
		List<ComicDTO> resultadosComicDTO = new ArrayList<ComicDTO>();
		List<Comic> resultados = entityManager.createQuery("Select c from comic c").getResultList();
	...
	/**
	 * 
	 * Metodo encargado de comvertir comic <b>Caso de Uso</b>
	 * 
	 * @author pedro
	 * 
	 * @param comicDTO
	...
	/**
	 * 
	 * Metodo encargado de comic a comicDTO <b>Caso de Uso</b>
	 * 
	 * @author pedro
	 * 
	 * @param comic
